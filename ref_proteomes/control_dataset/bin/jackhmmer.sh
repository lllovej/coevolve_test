...
jackhmmer -N 3 -A ${prefix}.sto ../seq_uniprot/${idname}.fasta ../homolog_seq/$filename
...
echo "reformat from sto to a3m"
#one line
echo "$(awk '/^>/{print a;a="";print;next}{a=a$0}END{print a}' ${prefix}.a3m )" > ${prefix}.a3m
sed -i '1d' ${prefix}.a3m

echo 'align to one line'
#trim the a3m to have the same length
/home/j/jlamb/pfs/call_scripts/a3mToTrimmed.py ${prefix}.a3m > ${prefix}.a3m_trim 
mv ${prefix}.a3m_trim ${prefix}.a3m


##clustalOmega to generate MSA
#clustalo -i $filename -o ../msa_clustalo/${prefix}.clu --outfmt=clu -v --wrap=5000 --threads=14
